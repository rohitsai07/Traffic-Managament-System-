...
class User_Location_Page extends StatefulWidget {
  ...
  State<User_Location_Page> createState() => _User_Location_Page_State(id: id);
}

class _User_Location_Page_State extends State<User_Location_Page> {
  String? id;
  var role;
  var email;
  var name;
  ...
  _User_Location_Page_State({required this.id});
